...
const TABS = [
  ...
  { label: "Leaderboard", href: "/dashboard/admin/leaderboard" },
];
...
export function AdminTabs() {
  ...
  return (
    <div className="w-full overflow-x-auto scrollbar-none mb-8">
      <div className="inline-flex items-center gap-1 bg-surface-raised/40 backdrop-blur-md border border-border-subtle/50 rounded-2xl p-1.5 shadow-sm min-w-max">
        {TABS.map((tab) => {
          const active =
